...
function TweetCard({ item }) {
    ...
    const like = () => {
        likeTweet(user.username, item._id);
    }

    const reply = () => {
        replyTweet(user.username, item._id, { text: text })
        setText('');
        setShowReplyModal(false);
    }

    const edit = () => {
        updateTweet(user.username, item._id, { text: text })
        setText('');
        setShowEditModal(false);
    }

    const del = () => {
        deleteTweet(user.username, item._id);
    }
    console.log(item);
    return (
            ...
            <div className="inner-body">
                ...
                <div className="body">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        {item.username === user.username && <span className="reply" onClick={() => setShowEditModal(true)}><i className="fa fa-edit"> Edit</i></span>}
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        {item.username === user.username && <span className="reply" onClick={del}><i className="fa fa-trash"> Delete</i></span>}
                    </div>
                </div>
            </div>
        </div>
