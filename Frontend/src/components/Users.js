                        ...
                        return (
                            <Col key={index}>
                                <Card>
                                    <div className="flex">
                                        <div>
                                            <img src={`https://robohash.org/${item.username}/set_set5?size=100x100`} alt={`${item.firstname} ${item.lastname}'s Profile Pic`} style={{ minWidth: '100px', maxWidth: '100px', maxHeight: "100px", minHeight: "100px", borderRadius: "50%", padding: "10px", alignSelf: "center" }} />
                                        </div>
                                        <div>
