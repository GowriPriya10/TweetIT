...
function Header() {
    ...
    return (
        <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-tweet">
            <img src={`https://robohash.org/${user.loginID}/set_set5?size=100x100`} alt="users profile pic" width="50" height="50" className="rounded-circle" />
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div className="form-inline mt-2 mt-md-0">
                    <h2 style={{ color: 'white' }}>TweetIt</h2>
                </div>
            </div>
        </nav>
    )
